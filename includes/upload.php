 ...
 * Es la única clase que escribe archivos PDF al disco;
 * todas las operaciones de subida pasan por aquí.
 *
 * Flujo principal:
 *   1. Validar que el archivo sea un PDF real (MIME type)
 *   2. Crear el directorio de destino si no existe
 *   3. Intentar comprimir con Ghostscript
...
class Flipbook_Upload {
     ...
     *
     * @param  array        $archivo  Elemento de $_FILES con tmp_name, name, etc.
     * @return array|WP_Error         Array con datos del PDF o error.
     */
