    ...
    public static function renderizar( $atts ) {
        ...
        <div class="flipbook-contenedor" 
            ...
            <div class="flipbook-barra">
                ...
                <div class="barra-grupo">
                    <button class="flipbook-btn btn-zoom-out" title="Alejar">−</button>
                    <button class="flipbook-btn btn-zoom-reset" title="Zoom original">⊙</button>
                    <button class="flipbook-btn btn-zoom-in" title="Acercar">+</button>
                </div>
